...
__global__ void ComputeGain(const int *pnNumofKeyValues, const long long *pnFeaStartPos, const nodeStat *pSNodeStat,
							...
							const float_point *pGDOnEachFeaValue, const float_point *pHessOnEachFeaValue,
							float_point *pGainOnEachFeaValue)
{
	...
	int bufferPos = snId * nFeaValueInBatch + curFeaStartPosInBatch + tidForEachFeaValue;
	float_point rChildGD = pGDOnEachFeaValue[bufferPos];
	float_point rChildHess = pHessOnEachFeaValue[bufferPos];
 ...
 */
__global__ void PickLocalBestSplit(const int *pnNumofKeyValues, const long long *pnFeaStartPos, const float_point *pGainOnEachFeaValue,
