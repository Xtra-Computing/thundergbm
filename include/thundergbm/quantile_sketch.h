...
public:
    ...
    summary(): entry_size(0) {entries.clear();};
    summary(int entry_size, int reserve_size): entry_size(entry_size) {entries.resize(reserve_size);};
...
public:
    ...
    quanSketch(): numOfLevel(0), summarySize(0) {summaries.clear();};
